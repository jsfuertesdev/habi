...
class TestPropertyService(unittest.TestCase):
    ...
    def test_get_properties_no_filters(self, mock_db):
        ...
        mock_cursor.fetchall.return_value = [
            {"address": "carrera 100 #15-90", "city": "bogota", "state": "en_venta", "price": 350000000, "description": "Amplio apartamento en conjunto cerrado"}
        ]
        ...
        self.assertEqual(result[0]['description'], 'Amplio apartamento en conjunto cerrado')
        mock_cursor.execute.assert_called_once()
        Logger.add_to_log("info", "Test test_get_properties_no_filters runned successfully")
    ...
    def test_get_properties_with_filters(self, mock_db):
        ...
        Logger.add_to_log("info", "Test test_get_properties_with_filters runned successfully")

    def test_property_handler_get(self):
        response = requests.get('http://localhost:8000/properties?year=2020&city=bogota')
